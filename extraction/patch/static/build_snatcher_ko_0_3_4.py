...
TSVs alone:
    ...
    python build_snatcher_ko_0_3_4.py              full build (stages 1-3)
    python build_snatcher_ko_0_3_4.py --stage3     stage 3 only, reusing stage 1/2
    python build_snatcher_ko_0_3_4.py --check      validate inputs, build nothing
...
revert:
    ...
    SNATCHER_PRELOAD_PACKS=0 python build_snatcher_ko_0_3_4.py
...
PROTECTED = {VERSION, "0.3.3", STAGE1_VERSION, "ac_0.1.14", "0.2.26"}
...
def main() -> None:
    ...
    # `SNATCHER_PRELOAD_PACKS=0 python build_snatcher_ko_0_3_4.py` still works
