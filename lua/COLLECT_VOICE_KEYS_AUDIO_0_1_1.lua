...
local OUT="C:/snatcher/snatcher_tool/logs/voice_key_events_raw_v011.tsv"
local CLIPS="C:/snatcher/snatcher_tool/logs/voice_clips_v011_fresh/"
...
emu.log("COLLECT_VOICE_KEYS_AUDIO 0.1.1 loaded -- 음성 전용")
emu.log("  ADPCM key = sector 3 B + end address 2 B + rate 1 B · full RAM clip · CDDA sector range")
