-- Temporary bridge for the line UI POC: AC only, no game/BIOS/VDC writes.
local INPUT="C:/snatcher/build/subtitles/subtitle_line_ui_payload_v0_2_0.bin"
local BASE=0x1C0500
...
emu.log(string.format("SUBTITLE UI 0.2.0 AC PRELOAD PASS: %d B -> $%06X",#d,BASE))
