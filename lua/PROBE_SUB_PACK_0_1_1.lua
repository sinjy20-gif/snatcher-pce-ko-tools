-- PROBE_SUB_PACK 0.1.1  --  팩이 몬다 + **VRAM 을 빌리고 되돌린다**
--
-- 0.1.0 에서 무엇이 달라졌나
-- --------------------------
...
-- 출력  로그 + C:/snatcher/dump/probe_sub_pack_0_1_1_<날짜>.tsv
...
local function flush()
  local f = io.open(string.format('C:/snatcher/dump/probe_sub_pack_0_1_1_%s.tsv',
...
emu.log('PROBE_SUB_PACK 0.1.1 loaded')
