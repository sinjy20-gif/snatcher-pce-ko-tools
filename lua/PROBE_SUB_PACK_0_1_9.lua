-- PROBE_SUB_PACK 0.1.9  --  ADPCM 열쇠를 잰다
--
-- 무엇을 재나 (인계서 §3)
-- -----------------------
...
local function flush()
  local f = io.open(string.format('C:/snatcher/dump/probe_sub_pack_0_1_9_%s.tsv',
...
local KEYPATH = 'C:/snatcher/dump/probe_key_0_1_9_' .. STAMP .. '.tsv'
local CDDAPATH = 'C:/snatcher/dump/probe_cdda_0_1_9_' .. STAMP .. '.tsv'
...
emu.log('PROBE_SUB_PACK 0.1.9 loaded  --  자막 + 열쇠 측정')
