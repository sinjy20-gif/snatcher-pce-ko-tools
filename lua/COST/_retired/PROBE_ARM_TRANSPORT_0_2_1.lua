-- PROBE_ARM_TRANSPORT 0.2.1 -- 671 B 재적재가 정말 필요한가
--
...
--
--   dump  snatcher_tool/logs/arm_transport_v021.tsv   ★프로브와 같은 판번호

local OUT = "C:/snatcher/snatcher_tool/logs/arm_transport_v021.tsv"
...
say("PROBE_ARM_TRANSPORT 0.2.1 -- 세고, arm 직후/클립끝 두 번 뜬다")
