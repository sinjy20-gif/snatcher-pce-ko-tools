-- PROBE_SUB_PACK 0.1.6  --  자막마다 **자리**를 갖는다 (위 · 중간 · 아래)
--
-- 왜
-- --
...
-- 출력  로그 + C:/snatcher/dump/probe_sub_pack_0_1_6_<날짜>.tsv
...
local function flush()
  local f = io.open(string.format('C:/snatcher/dump/probe_sub_pack_0_1_6_%s.tsv',
...
emu.log('PROBE_SUB_PACK 0.1.6 loaded')
