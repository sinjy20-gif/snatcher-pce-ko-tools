-- GFX 0.4.0 -- 헌정 화면을 **일대일로 식별하는 값**을 찾는다  ★순수 관측 · 쓰기 0 B · 화면에 안 그림
--
-- 왜 이걸 재나
-- ---------------------------------------------------------------------------
...
--
-- 산출물  C:/snatcher/dump/gfxscene_0_4_0_<시각>_reads.tsv
--         C:/snatcher/dump/gfxscene_0_4_0_<시각>_hits.tsv
--         C:/snatcher/dump/gfxscene_0_4_0_<시각>_summary.txt
...
local ZP_LO, ZP_HI = 0xF8, 0xFF  -- CD_READ 인자가 사는 제로페이지
...
local BASE  = 'C:/snatcher/dump/gfxscene_0_4_0_' .. STAMP
...
say('GFX 0.4.0-scene-id armed -- CD_READ $E009 + 업로더 $725C · 쓰기 0 B · 화면에 안 그림')
