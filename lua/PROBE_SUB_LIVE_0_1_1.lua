-- PROBE_SUB_LIVE 0.1.1  --  ADPCM 은 사건으로, CD-DA 는 시계로
--
...
emu.addEventCallback(function()
  ...
  if ok and s then
    ...
    if active == nil then
      ...
      local parts = seg and cdPartsByClip[seg.clip] or nil
      if parts == nil then
...
emu.log('PROBE_SUB_LIVE 0.1.1 loaded')
emu.log(string.format('  ADPCM 이벤트 %d · 자막 %d | CD-DA 구간 %d · 자막 %d | 글꼴 %d 자',
        #er, nsub, #cdSegs, ncdsub, nglyphs))
