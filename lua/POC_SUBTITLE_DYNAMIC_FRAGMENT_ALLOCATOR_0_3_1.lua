...
local VERSION = rawget(_G, 'SUB_ALLOCATOR_VERSION') or '0.3.1'
local INPLACE_IMAGES = rawget(_G, 'SUB_ALLOCATOR_INPLACE_IMAGES') == true
local TARGET_END = rawget(_G, 'SUB_ALLOCATOR_TARGET_END')
local PATCH_AT_COUNT_OK = rawget(_G, 'SUB_ALLOCATOR_PATCH_AT_COUNT_OK') == true
