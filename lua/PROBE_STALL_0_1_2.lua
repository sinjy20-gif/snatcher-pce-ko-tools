-- PROBE_STALL 0.1.2  --  루프를 주소 단위로 짚고 그 자리 바이트를 떠 온다
--
-- 0.1.1 이 알려준 것
-- ---------------------------------------------------------------------------
...
local OUTPATH = 'C:/snatcher/dump/probe_stall_0_1_2_' .. STAMP .. '.tsv'
...
emu.log('PROBE_STALL 0.1.2 loaded  --  아무것도 안 쓴다 · ADPCM RAM 도 안 읽는다')
