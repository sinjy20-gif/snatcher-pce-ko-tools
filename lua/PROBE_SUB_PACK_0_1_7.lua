-- PROBE_SUB_PACK 0.1.7  --  왜 9 칸에서 잘리나를 센다
--
...
-- 출력  로그 + C:/snatcher/dump/probe_sub_pack_0_1_7_<날짜>.tsv
...
local function flush()
  local f = io.open(string.format('C:/snatcher/dump/probe_sub_pack_0_1_7_%s.tsv',
...
emu.log('PROBE_SUB_PACK 0.1.7 loaded')
