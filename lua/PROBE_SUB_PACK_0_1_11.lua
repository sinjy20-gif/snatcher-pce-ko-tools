-- PROBE_SUB_PACK 0.1.11  --  열쇠를 (sector, 끝주소) 로
--
...
local function flush()
  local f = io.open(string.format('C:/snatcher/dump/probe_sub_pack_0_1_11_%s.tsv',
...
local KEYPATH = 'C:/snatcher/dump/probe_key_0_1_11_' .. STAMP .. '.tsv'
local CDDAPATH = 'C:/snatcher/dump/probe_cdda_0_1_11_' .. STAMP .. '.tsv'
...
emu.log('PROBE_SUB_PACK 0.1.11 loaded  --  열쇠 (sector, 끝주소)')
