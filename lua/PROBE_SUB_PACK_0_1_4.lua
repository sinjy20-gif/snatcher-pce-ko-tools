-- PROBE_SUB_PACK 0.1.4  --  열쇠를 **끝 주소**로 바꿨다
--
-- 0.1.3 이 무엇을 보여줬나
-- ------------------------
...
-- 출력  로그 + C:/snatcher/dump/probe_sub_pack_0_1_4_<날짜>.tsv
...
local function flush()
  local f = io.open(string.format('C:/snatcher/dump/probe_sub_pack_0_1_4_%s.tsv',
...
emu.log('PROBE_SUB_PACK 0.1.4 loaded')
